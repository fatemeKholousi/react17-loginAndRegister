...
//         }
// const handleSelectEducation=(e)=>{ setSelect_edu({value:e.target.value})
...
//     alert(`بعنوان اسم ${fname} را وارد کرده اید`);}
    return (
        ...
        <select id="education_select" onChange={(e)=>setSelect_edu({value:e.target.value})}  required>
